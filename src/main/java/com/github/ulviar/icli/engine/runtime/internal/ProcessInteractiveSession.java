...
import com.github.ulviar.icli.engine.SessionLifecycleObserver;
...
public final class ProcessInteractiveSession implements InteractiveSession {
    ...
    public ProcessInteractiveSession(
