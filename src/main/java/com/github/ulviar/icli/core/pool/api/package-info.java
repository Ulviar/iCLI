 ...
 * com.github.ulviar.icli.core.pool.api.ProcessPool} and the accompanying configuration, diagnostics, and lease types
 * that callers use to borrow long-lived {@link com.github.ulviar.icli.core.InteractiveSession} instances.
 *
 ...
 * com.github.ulviar.icli.core.pool.api.ProcessPoolConfig} and return {@link
 * com.github.ulviar.icli.core.pool.api.WorkerLease} handles that wrap the underlying session and enforce the pool’s
 * lifecycle rules.
 *
 ...
 *
 * @see com.github.ulviar.icli.core.pool.api.ProcessPool
 * @see com.github.ulviar.icli.core.pool.api.ProcessPoolConfig
 * @see com.github.ulviar.icli.core.pool.api.WorkerLease
 */
@NotNullByDefault
