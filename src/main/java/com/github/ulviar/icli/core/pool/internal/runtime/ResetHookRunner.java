...
import com.github.ulviar.icli.core.pool.api.PoolDiagnosticsListener;
...
import com.github.ulviar.icli.core.pool.api.hooks.ResetOutcome;
...
public final class ResetHookRunner {
     ...
     * {@link com.github.ulviar.icli.core.pool.api.PoolDiagnosticsListener#workerFailed(int, Throwable)}
     ...
     *                com.github.ulviar.icli.core.pool.api.LeaseScope})
     * @param request context describing why the reset is being performed
     *
     * @return {@link RetireDecision#retire(com.github.ulviar.icli.core.pool.api.WorkerRetirementReason)} when the
     ...
     * @see ResetOutcome
     * @see RetireDecision
     * @see com.github.ulviar.icli.core.pool.api.WorkerRetirementReason
     */
