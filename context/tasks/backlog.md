...
| ICLI-002 | Consolidate execution requirements | Backlog | Planning | Map functional and non-functional requirements for single-run, interactive, and pooled process modes. | Capture maintainer use cases and document cross-platform constraints ahead of architecture work. | [context/tasks/ICLI-002/README.md](ICLI-002/README.md) | Prepares inputs for Phase 2 architecture design. |
