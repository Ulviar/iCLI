...
## Knowledge consulted
- [context/roadmap/execution-architecture-brief.md](../../roadmap/execution-architecture-brief.md) — Confirmed the
...
- [context/roadmap/process-pool-architecture.md](../../roadmap/process-pool-architecture.md) — Provided the advanced API
  contracts (ProcessPool, WorkerLease, diagnostics) that pooled clients must expose or wrap without breaking invariants.
...
- [context/research/experiments/kotlin-solution-audit.md](../../research/experiments/kotlin-solution-audit.md) —
