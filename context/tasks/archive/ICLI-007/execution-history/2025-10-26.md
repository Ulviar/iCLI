...
- `EXPLANATION.md` — Recorded the Russian-language decision log: context, evaluated options, selected hybrid strategy, outlined testing expectations, and listed next steps.
...
- Process improvement: automate dossier scaffolding via a script to avoid manual copy/paste for future tasks.
