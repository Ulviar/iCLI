...
- [context/tasks/backlog.md](/context/tasks/backlog.md) — Clarified the Definition of Done: deliver a written design for
  ...
  dossier.
- [context/tasks/archive/ICLI-016/analysis/2025-11-03.md](/context/tasks/archive/ICLI-016/analysis/2025-11-03.md) —
  Provided the maintainer-approved direction for splitting `CommandService` and introducing pooled runner types plus
  shared execution templates.
