...
- [Execution use case catalogue](../../../../roadmap/execution-use-case-catalogue.md) — Highlighted scenarios
  (long-lived automation, heterogeneous command reuse) to ensure the pool handles state reset and eviction.
...
- [Execution engine benchmarks](../../../../research/icli-execution-engine-benchmarks.md) — Emphasised industry lessons
  on state isolation, transcript logging, and cautious pooling applicability.
