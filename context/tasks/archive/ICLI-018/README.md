...
## Planning
- **Scope summary:** Capture the authoritative scenario list (stateless, listen-only, MCP, stateful, etc.) and ensure it
  stays discoverable for future roadmap phases.
- **Proposed deliverables:** Updated scenario catalogue
  ([execution-use-case-catalogue.md](/context/roadmap/execution-use-case-catalogue.md)), planning/analysis logs, and
  backlog updates for related work.
...
- **Follow-up work:** Update roadmap/backlog (ICLI-019) and clarify public API boundaries (ICLI-020); resume ICLI-016
  afterwards.
- **Retrospective:** Included in [execution-history/2025-11-02.md](execution-history/2025-11-02.md).
...
- **Links:** [ICLI-016 analysis log](analysis/2025-11-02.md)
