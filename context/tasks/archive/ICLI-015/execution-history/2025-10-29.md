...
## Follow-up & risks
- Optional improvements from `pool-refactoring-5.md` (single invariant assertions, timeout documentation, diagnostics
  debouncing) remain backlog candidates once higher-priority features settle.
...
## Follow-up & risks
- Remaining optional cleanups from `pool-refactoring-5.md` (assert consolidation, metrics debouncing) can be revisited
  if future profiling highlights the need.
