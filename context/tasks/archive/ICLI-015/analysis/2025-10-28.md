...
- [Execution Architecture Brief](../../../../roadmap/execution-architecture-brief.md) — Clarifies how the pool plugs
  into the existing runtime (reusing `ProcessEngine.startSession`, `ShutdownExecutor`, diagnostics bus) and the layering
  between advanced and essential APIs.
- [Execution Requirements Brief](../../../../roadmap/execution-requirements.md) — Reiterates timeout, resource safety,
  and cross-platform expectations that the pool must preserve when recycling interactive sessions.
