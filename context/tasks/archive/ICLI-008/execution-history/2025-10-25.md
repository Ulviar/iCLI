...
- Updated `context/guidelines/icli/assistant-notes.md` with the mandated workflow: document-first testing, strict TDD
  sequencing, and aggressive responsibility separation so future contributors inherit the process.
...
- `context/guidelines/icli/assistant-notes.md` — added “Process documentation & TDD discipline” section mirroring the
