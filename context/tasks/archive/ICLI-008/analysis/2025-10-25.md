...
## Knowledge consulted
- [context/roadmap/project-roadmap.md](../../../../roadmap/project-roadmap.md) — Confirmed that Phase 3 prioritises the
...
- [context/roadmap/execution-architecture-brief.md](../../../../roadmap/execution-architecture-brief.md) — Clarified
...
- [context/knowledge-base/operations/Java Terminal & Process
  Integration.md](/context/knowledge-base/operations/Java%20Terminal%20%26%20Process%20Integration.md) — 
  Reiterated the need to drain stdout/stderr concurrently, avoid shells unless required, and prepare for future PTY 
  integration. Guides the buffer/pump design choices and reinforces the distinction between pipe-based v. PTY launches.
