...
## Knowledge consulted
- [Execution architecture brief](../../../../roadmap/execution-architecture-brief.md) — Defines the hybrid modality plan
...
- [Coding standards](../../../../guidelines/coding/standards.md) — Reiterates documentation, nullability, and TDD
  expectations; informs how new Java types (ClientScheduler) must be annotated and documented.
- [Assistant notes](../../../../guidelines/icli/assistant-notes.md) — Emphasises record usage, documentation, and
  test-first process; confirms virtual-thread preference for IO pumps aligns with using them in the scheduler.
- [CommandServiceTest](../../../../../src/test/kotlin/com/github/ulviar/icli/client/CommandServiceTest.kt) & existing 
  client sources — Establish current behaviour to extend (blocking helpers only), highlight where scheduler 
  injection has to happen, and show available test doubles (RecordingExecutionEngine, ScriptedInteractiveSession).
