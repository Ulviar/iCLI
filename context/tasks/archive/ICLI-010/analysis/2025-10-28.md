...
## Knowledge consulted
- [context/roadmap/execution-architecture-brief.md](../../../../roadmap/execution-architecture-brief.md) — Reaffirmed
  the expectation that streaming capture should be exposed through `OutputCapture.streaming()` with
  diagnostics/truncation events routed via the runtime bus; clarified that Essential APIs rely on these hooks for
  telemetry.
