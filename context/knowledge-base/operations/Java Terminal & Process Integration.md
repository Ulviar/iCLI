...
- **Windows**
- Classic console apps use the Windows Console API. For terminal emulation over byte streams, use **ConPTY** (available
  on modern Windows 10+). Without ConPTY, many TUIs won’t behave correctly under pipes.
